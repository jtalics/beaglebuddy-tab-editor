...
/**
 * called when the user selects one of the <i>rest</i> icons from the <i>rest</i> toolbar.
 */
public class RestAction extends BaseAction
{
    ...
    */
   public RestAction(MainFrame frame)
   {
      super(frame);
   }

   /**
    * toggle the type of rest to the song at the current location.
    * <br/><br/>
   ...
   public void actionPerformed(ActionEvent event)
   {
      ...
      // todo: toggle the rest to the song at the current location.
