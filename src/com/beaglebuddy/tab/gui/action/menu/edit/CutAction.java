...
/**
 * called when the user selects the <i>Cut</i> menu item from the <i>Edit</i> menu.
 */
public class CutAction extends BaseAction
{
    ...
    */
   public CutAction(MainFrame frame)
   {
      super(frame);
   }

   /**
    * cuts the selected content from the song and pastes it to the clipboard.
    * <br/><br/>
